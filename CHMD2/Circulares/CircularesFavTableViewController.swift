//
//  CircularesFavTableViewController.swift
//  CHMD2
//
...
class CircularesFavTableViewController: UITableViewController,UISearchBarDelegate,UIGestureRecognizerDelegate {
        ...
        barBusqueda.delegate=self
          ...
          if self.revealViewController() != nil {
           ...
           idUsuario = UserDefaults.standard.string(forKey: "idUsuario") ?? "0"
              ...
              btnLeer.frame=CGRect(x: 300, y: 300, width: 64, height: 64)
    ...
    override func tableView(_ tableView: UITableView,
       ...
       */
       ...
       override func tableView(_ tableView: UITableView, trailingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
           ...
           let noleeAction = self.contextualUnreadAction(forRowAtIndexPath: indexPath)
           let swipeConfig = UISwipeActionsConfiguration(actions: [eliminaAction,noleeAction])
           return swipeConfig
       }
      ...
      func contextualDelAction(forRowAtIndexPath indexPath: IndexPath) -> UIContextualAction {
       ...
       func obtenerCirculares(limit:Int){
           ...
           let address="https://www.chmd.edu.mx/WebAdminCirculares/ws/getCircularesFavoritas.php?usuario_id=\(self.idUsuario)"
